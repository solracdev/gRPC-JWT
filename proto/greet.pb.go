...
type HelloResponse struct {
	...
	Message string `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"` // 1 is the position
}
...
type NameList struct {
	...
	Name []string `protobuf:"bytes,1,rep,name=name,proto3" json:"name,omitempty"` // The order of the repeated values will be preserved.
}
